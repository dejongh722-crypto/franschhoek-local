      ...
      {showProfile && (
        <div className="pointer-events-none fixed inset-x-0 top-0 z-40 mx-auto max-w-md">
          <button
            ...
            className="pointer-events-auto absolute right-4 top-[calc(env(safe-area-inset-top)+0.75rem)] grid h-9 w-9 place-items-center rounded-full bg-white/80 text-ink shadow-sm ring-1 ring-black/10 backdrop-blur transition-colors hover:bg-white"
          >
