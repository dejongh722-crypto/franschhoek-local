...
import { Lock, Crown, Tag, Sparkles, MessagesSquare } from "lucide-react";
...
export function DealsLocked() {
  ...
  return (
    <div className="relative px-5 py-6">
      ...
      <div className="pointer-events-none select-none space-y-4 opacity-60 blur-[3px]" aria-hidden>
      ...
      <div className="absolute inset-0 grid place-items-center bg-gradient-to-b from-sand/40 via-sand/80 to-sand px-5">
        <div className="w-full max-w-sm rounded-3xl bg-card p-6 text-center shadow-xl ring-1 ring-line">
          ...
          <h2 className="mt-1 font-display text-2xl font-semibold text-ink">Unlock Local Deals</h2>
          <p className="mt-2 text-sm leading-relaxed text-muted">
            Exclusive discounts from Franschhoek's wineries, restaurants and more — plus premium events and
