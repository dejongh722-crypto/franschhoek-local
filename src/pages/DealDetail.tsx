    ...
    <div className="pb-8">
      ...
      <div className="relative -mt-5 rounded-t-3xl bg-sand px-5 pt-6">
        ...
        <button
          ...
          className="mt-3 flex w-full items-center justify-center gap-2 rounded-2xl border border-line bg-white py-3 text-sm font-semibold text-ink transition-colors hover:bg-black/[0.02]"
        >
